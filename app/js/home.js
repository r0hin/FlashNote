...
function getPosts() {
  ...
  db.collection('posts').where("enabled", "==", true).get().then(function (querySnapshop) {
    querySnapshop.forEach(function (doc) {
      ...
      a.innerHTML = '<div style="text-align: left; width: 100%;" class="card"><div class="card-body"><div style="position: absolute; text-align: left"> <img style="border-radius: 42px; width: 42px;" src="' + doc.data().authorurl + '"/> <b> ' + doc.data().author + '</b></div><center><div style="display: inline-block;"  id="' + doc.data().title + 'deletebtn' + '"><br><br><br></div></center><h4 style="display: inline-block;" >' + doc.data().title + '</h4><hr><h5 style="text-align: left;">' + doc.data().content + '</h5><hr><button onclick="upvotepost(' + upvotefunc + ')" class="waves-flat-button btn-text-primary"><i class="material-icons">thumb_up</i> <div style="display: inline-block" id="' + doc.data().title + 'upvotes"></div></button> <button onclick="downvotepost(' + downvotefunc + ')" class="waves-flat-button btn-text-primary"><i class="material-icons">thumb_down</i> <div style="display: inline-block" id="' + doc.data().title + 'downvotes"></div></button> <button onclick="comments(' + commentfunc + ')" class="waves-flat-button btn-text-primary"><i class="material-icons">comment</i> <div style="display: inline-block" id="' + doc.data().title + 'comments"></div></button></div></div>'


      if (doc.id == 'W52L1CDH1h8zVMbjEAKI' || doc.id == 'maXelvI9pLmOFUpUP9xc') {
        a.innerHTML = '<div style="width: 100%;" class="card"><div class="card-body"><div style="position: absolute; text-align: left"> <img style="border-radius: 42px; width: 42px;" src="' + doc.data().authorurl + '"/> <b> ' + doc.data().author + '</b></div><center><div style="display: inline-block;"  id="' + doc.data().title + 'deletebtn' + '"><br><br><br></div></center><h4 style="display: inline-block;" >' + doc.data().title + ' (Pinned) </h4><hr><h5 style="text-align: left;">' + doc.data().content + '</h5><hr><button onclick="upvotepost(' + upvotefunc + ')" class="waves-flat-button btn-text-primary"><i class="material-icons">thumb_up</i> <div style="display: inline-block" id="' + doc.data().title + 'upvotes"></div></button> <button onclick="downvotepost(' + downvotefunc + ')" class="waves-flat-button btn-text-primary"><i class="material-icons">thumb_down</i> <div style="display: inline-block" id="' + doc.data().title + 'downvotes"></div></button> <button onclick="comments(' + commentfunc + ')" class="waves-flat-button btn-text-primary"><i class="material-icons">comment</i> <div style="display: inline-block" id="' + doc.data().title + 'comments"></div></button></div></div>'
...
function buildComments(name) {
  ...
  document.getElementById('reportCommentBtn').onclick = function () {
    ...
    window.open('mailto:rohinarya12@gmail.com')
  }
  ...
  db.collection('posts').doc(name).get().then(function (doc) {
    ...
    for (let i = 0; i < doc.data().comments.length; i++) {
      ...
      if (a[0] == firebase.auth().currentUser.displayName) {
        ...
        b.innerHTML = '<div><img style="display: inline-block; width: 24px; height: 24px; border-radius: 24px;" src="' + a[1] + '" alt=""> ' + a[0] + '<br><br><p> ' + a[2] + '</p></div> <h5><div style="right: 10px; position: absolute;" class="dropdown"> <button class="waves-flat-button btn-text-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="material-icons">more_vert</i> </button> <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"> <a style="text-align: left; width: 100%;" href="mailto:rohinarya12@gmail.com" class="waves-flat-button btn-text-primary"><i class="material-icons">flag</i> Report</a><a style="text-align: left; width: 100%;" onclick="' + deleteFunc + '" class="waves-flat-button btn-text-primary"><i class="material-icons">delete</i> Delete</a> </div> </div></h5>'
      }
      else {
        b.innerHTML = '<div><img style="display: inline-block; width: 24px; height: 24px; border-radius: 24px;" src="' + a[1] + '" alt=""> ' + a[0] + '<br><br><p> ' + a[2] + '</p></div> <h5><div style="right: 10px; position: absolute;" class="dropdown"> <button class="waves-flat-button btn-text-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="material-icons">more_vert</i> </button> <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"> <a style="text-align: left; width: 100%;" href="mailto:rohinarya12@gmail.com" class="waves-flat-button btn-text-primary"><i class="material-icons">flag</i> Report</a> </div> </div></h5>'
      }
...
function getflashcards() {
  ...
  db.collection('users').doc(user()).collection('flashcards').get().then(function (querySnapshop) {
    querySnapshop.forEach(function (doc) {
      ...
      a.innerHTML = '<div style="display: inline-block; width: 100%; height: 220px;" class="card waves-float-box shadow-sm"><div class="card-body"><div style="position: absolute;left: 50%;top: 50%;transform: translate(-50%,-50%);"><h4>' + doc.id + '</h4><button onclick="' + deleteFunc2 + '" class="waves-flat-button btn-flat-primary"><i class="material-icons">delete</i></button></div></div></div>'
    ...
    .onSnapshot(function (querySnapshot) {
      ...
      querySnapshot.forEach(function (doc) {
        ...
        if (firebase.auth().currentUser.displayName == doc.data().sender) {
          ...
          a.innerHTML = '<div style="padding: 20px; text-align: left;" class="card-body"><img style="display: inline-block; width: 35px; border-radius: 25px;" src="' + doc.data().senderimg + '"><h4 style="padding-left: 10px; display: inline-block;"> ' + doc.data().sender + '</h4><h5 style="padding-left: 10px; display: inline-block;"> ' + timeel + '</h5><div style="right: 10px; position: absolute;" class="dropdown"> <button class="waves-flat-button btn-text-primary dropdown-toggle waves-effect waves-button" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="material-icons">more_vert</i> </button> <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 34px, 0px); top: 0px; left: 0px; will-change: transform;"> <a style="text-align: left; width: 100%;" href="mailto:rohinarya12@gmail.com" class="waves-flat-button btn-text-primary waves-effect waves-button"><i class="material-icons">flag</i> Report</a> </div> </div><br><br><p>' + doc.data().content + '</p></div>'
